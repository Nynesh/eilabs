<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="projectdiscovery.aspx.cs" Inherits="ei_labs.projectdiscovery" %>
            ...
            <div class="jumbotron" style="background-color:white;margin-bottom:0px">
                <div class="row">
                    <div class="col-md-5" style="margin-top:-2%">
                        <img src="images/discoveryawards.png" class="img-responsive" alt="Logo of Discovery Awards"/>
...
disabilities across India use in their daily lives.</span></p>
                        ...
                        <p class="hdstyle2"><b>Last Date of Submission: 15 September 2022</b></p>
                        <p style="margin-bottom: 0px"><a class="btn btn-lg btncss" target="_blank" href="https://forms.gle/qLd84byoVDg8c7qz7">Submit Your Solution</a></p>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
...
<p><b style="color:black">Project Discovery</b>&nbsp;is a platform aimed at collating different solutions in the form of short videos and making them available to ALL.</p>
                    <p class="hdstyle2"><b>Last Date of Submission: 15 September 2022</b></p>
                    <p><a class="btn btn-lg btncss" id="button" href="https://forms.gle/qLd84byoVDg8c7qz7" target="_blank">Submit Your Solution</a></p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-7" style="padding-top:12%">
                            <div class="text-center">
                                <p style="border:2px solid black;color:black;padding:30px;background-color:gold" class="hdstyle2"><b>Prizes up to ₹ 5 Lakh to be won.</b></p>
                            </div>                            
                        </div>
                        <div class="col-md-5">
                            <div class="text-center">
            ...
            <div class="row" >
                <div class="col-md-3 text-center">
                    <img src="images/Daily_living.png" />
                    <div>
                        <h3 class="hdstyle2"><b>Daily-Living solutions</b></h3>
                    </div>
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div>
                        <h3 class="hdstyle2"><b>Workplace solutions</b></h3>
                    </div>
                    <p style="padding:0px 20px 0px 20px;margin:20px" class="txtstyle">
                ...
                <div class="col-md-3 text-center" >
                    <img src="images/Socializing.jpg" />
                    <div>
                        <h3 class="hdstyle2"><b>Social Inclusion solutions</b></h3>
                    </div>
                    <p style="padding:0px 20px 0px 20px;margin:20px" class="txtstyle">
                ...
                <div class="col-md-3 text-center">
                    <img src="images/edu_training.jpg" />
                    <div>
                        <h3 class="hdstyle2"><b>Education & Training solution</b></h3>
                    </div>
                ...
                <div class="row">
                 <div class="text-center">                    
                        <p><a href="https://forms.gle/qLd84byoVDg8c7qz7" class="btn btn-lg btncss" target="_blank" >Submit Your Solution</a></p>
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-6 col-sm-6 myslides">
                    <div class="thumbnail thmbdr">
                        <img src="images/company/google.png" class="img-responsive" alt="Logo of Trinayani" />
                    </div>
                </div>
